                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      child: Container(
                          ...
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), border: Border.all(width: 0.8, color: Colors.purple)),
                          child: Center(
                            child: Text(
                              'Accept'.tr(),
                              style: TextStyle(color: isDarkMode(context) ? Color(0xffFFFFFF) : Colors.purple, fontFamily: "Poppinsm", fontSize: 15
                                ...
                                Padding(
                                  ...
                                  child: ElevatedButton(
                                    style: ElevatedButton.styleFrom(
                                      ...
                                      side: BorderSide(color: Colors.purple, width: 0.4),
                                      shape: RoundedRectangleBorder(
                                    ...
                                    child: Text(
                                      'View Rating'.tr(),
                                      style: TextStyle(letterSpacing: 0.5, color: isDarkMode(context) ? Colors.black : Colors.purple, fontFamily: 'Poppinsm'),
                                    ),
                                  ),
                                ),
                              ],
                  ...
                  Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(fontSize: 18, color: Colors.purple, letterSpacing: 0.5, fontFamily: 'Poppinssm'),
                        ),
                      ])),
                      ...
                      : Container(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            InkWell(
                              ...
                              child: Text(
                                "View".tr(),
                                style: TextStyle(fontSize: 18, color: Colors.purple, letterSpacing: 0.5, fontFamily: 'Poppinsm'),
                              ),
                            ),
                          ])),
                  Container(
