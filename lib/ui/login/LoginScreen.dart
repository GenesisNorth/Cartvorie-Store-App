          ...
          children: <Widget>[
              ...
              child: Padding(
                ...
                child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder:
                          OutlineInputBorder(borderRadius: BorderRadius.circular(25.0), borderSide: BorderSide(color: Colors.purple, width: 2.0)),
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration:
                    BoxDecoration(borderRadius: BorderRadius.circular(30), color: Colors.white, border: Border.all(color: Colors.purple, width: 1)),
                child: Padding(
