        ...
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(25), shape: BoxShape.rectangle, border: Border.all(color: Colors.grey.shade400)),
      ...
      if (result != null && result is User) {
        ...
        if(result.vendorID!=null && result.vendorID.isNotEmpty) {
            await FireStoreUtils.firestore.collection(VENDORS)
                .doc(result.vendorID).update({"fcmToken": result.fcmToken});
        }
