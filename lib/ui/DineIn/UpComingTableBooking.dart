                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(5), border: Border.all(width: 0.8, color: Colors.purple)),
                                        child: Center(
                                          child: Text(
                                            'Accept'.tr(),
                                            style: TextStyle(
                                                color: isDarkMode(context) ? Color(0xffFFFFFF) : Colors.purple, fontFamily: "Poppinsm", fontSize: 15
