                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(7.0), borderSide: BorderSide(color: Colors.purple, width: 2.0)),
                                ...
                                children: [
                                  ...
                                  DropdownButtonFormField<BrandsModel>(
                                      decoration: InputDecoration(
                                        contentPadding: new EdgeInsets.only(left: 8, right: 8),
                                        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(7.0), borderSide: BorderSide(color: Colors.purple, width: 2.0)),
                                        errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(7.0), borderSide: BorderSide(color: Colors.purple, width: 2.0)),
                                        focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(7.0), borderSide: BorderSide(color: Colors.purple, width: 2.0)),
                                        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(7.0), borderSide: BorderSide(color: Colors.purple, width: 2.0)),
                                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(7.0), borderSide: BorderSide(color: Colors.purple, width: 2.0)),
                                        // filled: true,
                                    ...
                                    itemBuilder: (context, index) {
                                      return Column(children: [
                                        ...
                                        child: Container(
                                          ...
                                          // radius: 20,
                                          child: IconButton(
                                            icon: Text("-",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: Colors.purple),),
                                            color: Colors.purple,
                                            iconSize: 20,
                                            padding: EdgeInsets.only(bottom: 0),
                                            onPressed: () {
