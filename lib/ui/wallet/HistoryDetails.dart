...
class _HistoryDetailsState extends State<HistoryDetails> {
  ...
  getTextBuild(String s, String value) {
    return Padding(
      ...
      child: Row(
        children: [Text(s,style: TextStyle(fontFamily: 'Poppinsm',fontSize: 18,color: isDarkMode(context)?Colors.white:Colors.black),),Spacer(),Text(value,style: TextStyle(fontFamily: 'Poppinsr',fontSize: 16,color: Colors.purple),)],
      ),
    );
  }
}
